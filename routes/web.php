...
//** Dashboard
  Route::get('/dashboard', function () {return View('dashboards.admin.dash');})->middleware(["auth","StudentPermission"])->name('dash');
//** Login
...
/******* route group-admin *******/
Route::group(["middleware"=>["auth","StudentPermission"]],function(){
//GET
...
/******* route student-admin *******/
//GET
Route::get("/student", "Admin\studentsController@index")->name("student");
