  ...
  $(".toggle-modal-show").click(function(){
      ...
      $.post("./get_students",{id_group: id_group},function(data){
            ...
            if(data.length != 0){
              ...
              //create table
              $("#modalGroup .modal-body").html("<table class='table'><thead><tr><th scope='col'>Prenom</th><th scope='col'>Nom</th><th scope='col'>Inscrit en</th></tr></thead><tbody></tbody></table>")
              while(i<data.length){
