...
$(function(){
    $("#saveEmail").click(function(event){
          ...
          if(email == ""){
            ...
            $(".Span_Err_Email").text("Champs obligatoire");
          }
          ...
          if(password == ""){
            ...
            $(".Span_Err_Pass").text("Champs obligatoire");
          }
          if(password_confirmation == ""){
            console.log("empty");
            isValid = false;
            $(".Div_Err_PassC").addClass('has-error');
            $(".Span_Err_PassC").text("Champs obligatoire");
          }
          ...
          if(isValid == true){
            $.post($("#SetNewEmailForm").attr("action"),{email:email,password:password, password_confirmation:password_confirmation},function(data){
                if(data == "wrong password"){ // password wrong
                  ...
                  swal({
                      title: 'Super!',
                      text: "Votre adresse email a été changé avec success! Essayer de se connecter",
                      type: 'success',
          ...
          $.post($("#EditPasswordForm").attr("action"),{
              ...
              if(data == "wrong password"){
                ...
                $("#passNouvConfirm").val("");
                 ...
                 swal({
                     title: 'Super!',
                     text: "Votre mot de passe a été changé avec success! Essayer de se connecter!",
                     type: 'success',
                     showCancelButton: false,
                     confirmButtonColor: '#3085d6',
                     confirmButtonText: 'Ok...!',
                ...
                swal({
                    title: 'Désolé!',
                    text: "Nous avons rencontré un problème durant la changement de votre mot de passe!",
                    type: 'warning',
                    showCancelButton: false,
                    confirmButtonColor: '#3085d6',
                    confirmButtonText: 'Ok...!'
